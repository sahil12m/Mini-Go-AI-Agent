...
def read_input(input_file):
    ...
    prev_board = [[int(val) for val in line]
                  for line in input_info[1:BOARD_SIZE+1]]
    board = [[int(val) for val in line]
             for line in input_info[BOARD_SIZE+1: 2*BOARD_SIZE+1]]
